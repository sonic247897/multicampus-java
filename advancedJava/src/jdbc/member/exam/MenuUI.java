...
public class MenuUI {
	...
	public void insertMenu(){
		...
		if(result>0) {
			System.out.println("인사 등록 성공");
		}
		else {
			System.out.println("인사 등록 실패");
		}
	...
	// <<memberlist는 처음에 null로 초기화 하지 않았기 때문에 if(memberlist == null)
	// 	사용할 수 없고 memberlist의 size가 0인지 로 체크한다.>>
	// ArrayList<MemberDTO> memberlist = new ArrayList<MemberDTO>();
	//MemberDTO member = null;
	
	public void selectMenu(){
		System.out.println("*******전체 사원조회********");
